            ...
            <div class="col-md-8">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" autocomplete="off" type="text" name="name" placeholder="Nama Lengkap" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" autocomplete="off" type="email" name="email" placeholder="Alamat Email" />
                    </div>
