            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body text-left">
                        <h1>Diary Viewer</h1>
                        <h4 style="text-align: left;">Control Center</h4>
                        <h6 style="text-align: left; margin-bottom: 10px;">Diary Control</h6>
                        <a class="btn btn-primary btn-lg float-left disabled" style="margin-right: 10px;" aria-disabled="true" href="lihat-diary.php">Lihat Diary</a>
                    ...
                    <div class="col-md-12" style="margin-bottom: 7px;">
                        <div class="card">
                            <div class="card-body text-left float-right">
                                <?php echo "<i><div style='font-size: 20px;'>" . $row["tanggal"] . "</i><br><span class='h4'>" . $row["judul"] . "</span><br><br>" . nl2br(htmlspecialchars($row["konten"])) . "</p></div>"; ?>
                            </div>
                        </div>
                    </div>
                </div>
